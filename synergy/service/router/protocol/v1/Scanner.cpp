...
#line 40 "Scanner.cpp.rl"
	{te = p+1;{ PROC(MouseDown) }}
	goto st168;
tr130:
#line 42 "Scanner.cpp.rl"
	{te = p+1;{ PROC(MouseMove) }}
	goto st168;
tr135:
#line 43 "Scanner.cpp.rl"
	{te = p+1;{ PROC(MouseRelMove) }}
	goto st168;
tr137:
#line 6 "Scanner.cpp.rl"
	{ data = p; }
...
#line 44 "Scanner.cpp.rl"
	{te = p+1;{ PROC(MouseWheelMove) }}
	goto st168;
tr161:
#line 51 "Scanner.cpp.rl"
	{te = p+1;{ PROC(Incompatible) }}
	goto st168;
tr190:
...
#line 34 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(ResetOptions) }}
	goto st168;
tr203:
#line 45 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(ClipboardData) }}
	goto st168;
tr204:
#line 12 "Scanner.cpp.rl"
	{ p--; p += (dlen * dsize); }
#line 45 "Scanner.cpp.rl"
	{te = p+1;{ PROC(ClipboardData) }}
	goto st168;
tr205:
#line 49 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(DragInfo) }}
	goto st168;
tr206:
#line 12 "Scanner.cpp.rl"
	{ p--; p += (dlen * dsize); }
#line 49 "Scanner.cpp.rl"
	{te = p+1;{ PROC(DragInfo) }}
	goto st168;
tr207:
#line 48 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(FileTransfer) }}
	goto st168;
tr208:
#line 12 "Scanner.cpp.rl"
	{ p--; p += (dlen * dsize); }
#line 48 "Scanner.cpp.rl"
	{te = p+1;{ PROC(FileTransfer) }}
	goto st168;
tr209:
#line 47 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(SetOptions) }}
	goto st168;
tr210:
#line 12 "Scanner.cpp.rl"
	{ p--; p += (dlen * dsize); }
#line 47 "Scanner.cpp.rl"
	{te = p+1;{ PROC(SetOptions) }}
	goto st168;
tr211:
#line 6 "Scanner.cpp.rl"
	{ data = p; }
...
#line 50 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(InfoQuery) }}
	goto st168;
tr215:
#line 27 "Scanner.cpp.rl"
	{te = p;p--;{ PROC(HelloBack) }}
	goto st168;
tr216:
#line 12 "Scanner.cpp.rl"
	{ p--; p += (dlen * dsize); }
#line 27 "Scanner.cpp.rl"
	{te = p+1;{ PROC(HelloBack) }}
	goto st168;
st168:
#line 1 "NONE"
	{ts = 0;}
...
#line 1 "NONE"
	{ts = p;}
#line 260 "Scanner.cpp"
	_widec = (*p);
	if ( 83u <= (*p) && (*p) <= 83u ) {
		_widec = (short)(256u + ((*p) - 0u));
		if ( 
#line 5 "Scanner.cpp.rl"
 flow == Flow::STC  ) _widec += 256;
	}
	switch( _widec ) {
		case 67: goto st1;
		case 68: goto st35;
...
#line 11 "Scanner.cpp.rl"
 (dlen > 0) && ((dlen * dsize) <= (pe - p))  ) _widec += 256;
