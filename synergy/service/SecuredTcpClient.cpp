...
static char const* const DSTRootX3_CA = R"CERT(-----BEGIN CERTIFICATE-----
...
static char const* const ISRGRootX1_CA = R"CERT(-----BEGIN CERTIFICATE-----
...
createTLSContext (std::string const& hostname) {
    ...
    ctx.add_certificate_authority (boost::asio::buffer (DSTRootX3_CA,
                                   std::strlen (DSTRootX3_CA)));

    ctx.add_certificate_authority (boost::asio::buffer (ISRGRootX1_CA,
                                   std::strlen (ISRGRootX1_CA)));
